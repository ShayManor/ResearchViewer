...
import { X, Database, Github, BookOpen, FileText } from 'lucide-react';
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm font-semibold text-gray-700">API Documentation</h3>
              </div>
              <p className="text-sm text-gray-600 leading-relaxed mb-2">
                API documentation with all endpoints, request/response schemas, and examples.
              </p>
              <a
                href="/api"
                target="_blank"
